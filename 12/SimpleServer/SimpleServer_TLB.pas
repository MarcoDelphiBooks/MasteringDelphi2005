...
// PASTLWTR : 1.2
// File generated on 6/24/2005 7:04:05 AM from Type Library described below.

// ************************************************************************  //
// Type Lib: D:\md2005code\12\SimpleServer\SimpleServer.tlb (1)
...
// *********************************************************************//
  INumberProp = interface(IUnknown)
    ...
    function Get_Value(out New: Integer): HResult; stdcall;
    function Set_Value(New: Integer): HResult; stdcall;
    function Increase: HResult; stdcall;
  end;
