...
{$R 'AdoNetClientForm.TWinForm.resources' 'AdoNetClientForm.resx'}
...
uses
  ...
  AdoNetClientForm in 'AdoNetClientForm.pas' {AdoNetClientForm.TWinForm: System.Windows.Forms.Form};
