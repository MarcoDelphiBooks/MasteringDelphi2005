...
{$R 'AdoNetServerForm.TWinForm.resources' 'AdoNetServerForm.resx'}
{%DelphiDotNetAssemblyCompiler 'c:\program files\common files\borland shared\bds\shared assemblies\3.0\Borland.Data.Provider.dll'}
{%DelphiDotNetAssemblyCompiler '$(SystemRoot)\microsoft.net\framework\v1.1.4322\System.Design.dll'}
{%DelphiDotNetAssemblyCompiler 'c:\program files\common files\borland shared\bds\shared assemblies\3.0\Borland.Data.Common.dll'}
{%DelphiDotNetAssemblyCompiler 'c:\program files\common files\borland shared\bds\shared assemblies\3.0\Borland.Data.DataSync.dll'}
...
uses
  ...
  AdoNetServerForm in 'AdoNetServerForm.pas' {AdoNetServerForm.TWinForm: System.Windows.Forms.Form};
