...
{%DelphiDotNetAssemblyCompiler 'RemotableLib.dll'}
{$R 'RemotableClientForm.TWinForm.resources' 'RemotableClientForm.resx'}
...
uses
  ...
  RemotableClientForm in 'RemotableClientForm.pas' {RemotableClientForm.TWinForm: System.Windows.Forms.Form};
