...
{$R 'RemotableForm.TWinForm.resources' 'RemotableForm.resx'}
...
uses
  ...
  RemotableForm in 'RemotableForm.pas' {RemotableForm.TWinForm: System.Windows.Forms.Form};
