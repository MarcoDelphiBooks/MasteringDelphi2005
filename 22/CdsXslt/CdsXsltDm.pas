...
uses
  Windows, Messages, SysUtils, Classes, HTTPApp, Provider,
  DBClient, OleServer, xmldom, XMLIntf, msxmldom, XMLDoc, XSLProd, DB;
...
begin
  ...
  if Request.QueryFields.Values ['savexml'] = 'yes' then
    xmlDom.SaveToFile (xslfolder + 'customer.xml');
end;
