...
{$ENDIF}
{$IFDEF CLR}
  FBook := CreateCollection(TXMLBookTypeList, TypeInfo(TXMLBookType), 'book') as IXMLBookTypeList;
  FEbook := CreateCollection(TXMLEbookTypeList, TypeInfo(TXMLEbookType), 'ebook') as IXMLEbookTypeList;
{$ENDIF}
  inherited;
end;
...
{$ENDIF}
{$IFDEF CLR}
  FAuthor := CreateCollection(TXMLString_List, typeof(IXMLNode), 'author') as IXMLString_List;
{$ENDIF}
  inherited;
end;
